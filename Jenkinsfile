 ...
 //       }
        ...
        stage ('Deploy') {
            steps {
                ...
                sh 'ls /mavendb/repository/br/com/irrfweb/IRRFWeb/1.0-SNAPSHOT'
                sh 'docker run --name tomcat -d  -p 9090:8080 -v /mavendb/repository/br/com/irrfweb/IRRFWeb/1.0-SNAPSHOT/IRRFWeb-1.0-SNAPSHOT.war:/usr/local/tomcat/webapps/irrf.war tomcat'
            }
        }
        //////////////////////////////////////////////////////
    }
